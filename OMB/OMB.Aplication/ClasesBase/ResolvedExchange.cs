...
public class ResolvedExchange : Exchange
{
    ...
    public override IClonable Clone(){
        return new ResolvedExchange(this.sedeId, this.transportePosteadoId, this.transporteOfertadoId, this.happen){Id=this.Id, fechaYHora=this.fechaYHora, sede=this.sede, transporteOfertado=(this.transporteOfertado != null)? (TransportHistory)this.transporteOfertado.Clone() : null, transportePosteado=(this.transportePosteado != null)? (TransportHistory)this.transportePosteado.Clone() : null};
    }
